...
$convertconfiguration = [
    ...
    'columns' => [
        'type' => [
            'config' => [
                'items' => [
                    2 => ['LLL:EXT:campus_events_convert2ttnewscal/Resources/Private/Language/locallang_db.xlf:tx_campuseventsconnector_domain_model_convertconfiguration.convert2ttnews', 2, 'ext-convertconfiguration-type-ttnews']
                ]
            ]
        ],
    ],
...
$additionalFields = [
    'ttnews_type' => [
        'exclude' => 0,
        'label' => 'LLL:EXT:campus_events_convert2ttnewscal/Resources/Private/Language/locallang_db.xlf:tx_campuseventsconnector_domain_model_convertconfiguration.ttnews_type',
        'config' => [
            'type' => 'select',
